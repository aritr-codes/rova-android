...
class SessionCaptionTest {
    @Test fun listMeta_joinsAllParts() {
        assertEquals(
            "12 clips · 1m 04s · 84 MB",
            SessionCaption.listMeta(clipCountLabel = "12 clips", durationLabel = "1m 04s", sizeLabel = "84 MB"),
        )
    }
    @Test fun listMeta_dropsBlankClipCount_forLegacyRow() {
        assertEquals(
            "0m 22s · 19 MB",
            SessionCaption.listMeta(clipCountLabel = "", durationLabel = "0m 22s", sizeLabel = "19 MB"),
        )
    }
