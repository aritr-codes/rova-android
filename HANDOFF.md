...
**Do NOT pick (stale/blocked):** Library/History redesign (DONE) · `checkA11y*` suite (DONE, #114) · PR-6 interactive timeline (DONE, #127) · icon 5b-1 foundation (DONE, #128) · icon 5b-2/5b-3/5b-5 (DONE, #130/#131/#132) · differentiated cues (DONE, #133) · PR-δ FrontBack/DualSight (silicon-blocked on RZCYA1VBQ2H) · `UI_ROADMAP.md` (superseded).
