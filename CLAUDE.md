...
- Baseline: **2348 tests / 0-0-0** on master (`8083b675`, measured post-merge). A new feature lands its tests in the same PR. The full suite needs `--max-workers=2` on this box.
