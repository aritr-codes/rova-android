...
Owner-mandated for **every UI feature** (2026-07-04): **never implement UI from memory.**

Idea → Interactive HTML → Review → Refine → **Freeze design** → Compose implementation → **Pixel-match review** → Merge
