...
class RegistryTest {
    ...
    /**
     * The registry must hold EXACTLY the 48 gate ids — no missing/extra/typo.
     * Update EXPECTED_IDS as each batch lands; final value is all 48.
     */
    @Test
    ...
    companion object {
        // All 48 gate ids — final registry.
